...
<ul>
	<li><a href="https://github.com/EAkeweje/GPmix" target="_blank">GPmix</a>: GPmix is for the cluster analysis of one-dimensional functional data. It is built on the property that the projection coefficients of the functional data onto any given projection function follow a univariate Gaussian mixture model.  </li>
